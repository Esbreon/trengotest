...
def send_whatsapp_message(naam, monteur, dagnaam, datum, begintijd, eindtijd, reparatieduur, dp_nummer, mobielnummer):
    ...
    payload = {
        ...
        "hsm_id": os.environ.get('WHATSAPP_TEMPLATE_ID_VES_HERINNERING'),
        "params": [
    ...
    try:
        ...
        try:
            excel_file = outlook.download_excel_attachment(
                ...
                subject_line=os.environ.get('SUBJECT_LINE_VES_HERINNERING')
            )
...
if __name__ == "__main__":
    ...
    required_vars = [
        ...
        'OUTLOOK_PASSWORD',
        'SENDER_EMAIL', 
        'SUBJECT_LINE_VES_HERINNERING',
        'WHATSAPP_TEMPLATE_ID_VES_HERINNERING',
        'TRENGO_API_KEY'
    ]
